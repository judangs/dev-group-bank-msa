...
public class PaymentHistoryController {
    ...
    @GetMapping("/history")
    public ResponseEntity<? super ResponseDto> record(@AuthenticatedUser AuthClaims authClaims,
    ...
    public ResponseEntity<? super ResponseDto> detail(@AuthenticatedUser AuthClaims authClaims,
                                                      HistoryRecordRequest request) {
