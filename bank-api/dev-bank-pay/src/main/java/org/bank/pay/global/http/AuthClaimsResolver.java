...
public class AuthClaimsResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        parameter.hasParameterAnnotation(AuthenticationClaims.class);
    }
    ...
    public Object resolveArgument(MethodParameter parameter,
        ...
        AuthenticationClaims annotation = parameter.getParameterAnnotation(AuthenticationClaims.class);
